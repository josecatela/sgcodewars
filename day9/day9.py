...
Jens_setup = '''
from __main__ import Jens_day9
'''

def Jens_day9(morse_code):
...
Krzysztof_Błach_setup = '''
from __main__ import Krzysztof_Błach_day9
'''

def Krzysztof_Błach_day9(morse_code):
...
TEST_CODE_Krzysztof_Błach = '''
result = Krzysztof_Błach_day9('.... . -.--   .--- ..- -.. .')
'''
...
print("Time for Krzysztof_Błach test code: " + str(timeit.timeit(stmt=TEST_CODE_Krzysztof_Błach, setup=Krzysztof_Błach_setup, number=100000)) + " seconds")
